...
def main():
    ...
    wp2 = make_pose(8.0, 0.0, 0.0)          # Sample goal pose. Make your own! You can create multiple way points
    # 3. Go to first waypoint
    send_and_wait(wp2)
    time.sleep(wait_seconds)
    
    wp3 = make_pose(25.0, 0.0, 0.0)          # Sample goal pose. Make your own! You can create multiple way points
    # 3. Go to first waypoint
    send_and_wait(wp3)
    time.sleep(wait_seconds)


    wp4 = make_pose(25.0, 15.0, 0.0)          # Sample goal pose. Make your own! You can create multiple way points
    # 3. Go to first waypoint
    send_and_wait(wp4)
    time.sleep(wait_seconds)

    wp5 = make_pose(6.0, 15.0, 0.0)          # Sample goal pose. Make your own! You can create multiple way points
    # 3. Go to first waypoint
    send_and_wait(wp5)
    time.sleep(wait_seconds)

    wp6 = make_pose(0.0, 0.0, 0.0)          # Sample goal pose. Make your own! You can create multiple way points
    # 3. Go to first waypoint
    send_and_wait(wp6)
    time.sleep(wait_seconds)
